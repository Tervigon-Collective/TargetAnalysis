...
- `white_space_target_vs_competitor.png` – target vs competitors by mission

## Understanding the Charts

**Why does target vs Competitors sometimes show target at 0%?**
...
**Gap** = competitor_median_density - focus_density. Positive gap = target under-invested vs competitor brands.
...
3. **Low gap (target ahead)** → Maintain or optimize; no expansion needed.