...
- **Focus brand:** universal thread
- **Competitor brands:** gap
- **Total gap cells:** 42
- **Gap cells with competitor_count >= 2:** 30
- **Top opportunity (gap):** Shoes & Accessories | micro_mini_impulse | 35_50 (gap=100.0%)
...
- `white_space_target_vs_competitor.png` – universal thread vs gap by mission

## Understanding the Charts

**Why does universal thread vs Competitors sometimes show universal thread at 0%?**
...
**Gap** = competitor_median_density - focus_density. Positive gap = universal thread under-invested vs competitor brands.
...
3. **Low gap (universal thread ahead)** → Maintain or optimize; no expansion needed.