...
- **Focus brand:** wild fable
- **Competitor brands:** competitors
- **Total gap cells:** 153
- **Gap cells with competitor_count >= 2:** 83
...
- `white_space_target_vs_competitor.png` – wild fable vs competitors by mission

## Understanding the Charts

**Why does wild fable vs Competitors sometimes show wild fable at 0%?**
...
**Gap** = competitor_median_density - focus_density. Positive gap = wild fable under-invested vs competitor brands.
...
3. **Low gap (wild fable ahead)** → Maintain or optimize; no expansion needed.